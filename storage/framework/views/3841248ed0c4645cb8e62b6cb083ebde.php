...
<?php $__env->startSection('header', 'Tambah Artikel Baru'); ?>
...
<div class="bg-white rounded-lg shadow p-6 max-w-4xl">
    <form action="<?php echo e(route('admin.articles.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" value="<?php echo e(old('title')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <textarea name="excerpt" rows="3" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" required><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <textarea name="content" rows="10" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" required><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/shahib/Coding/Tanean laravel/resources/views/admin/articles/create.blade.php ENDPATH**/ ?>