...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" value="<?php echo e(old('name', $user->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="email" name="email" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" value="<?php echo e(old('email', $user->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <select name="role" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:border-blue-500" required>
                ...
                <option value="editor" <?php echo e(old('role', $user->role) == 'editor' ? 'selected' : ''); ?>>Editor</option>
                <option value="wartawan" <?php echo e(old('role', $user->role) == 'wartawan' ? 'selected' : ''); ?>>Wartawan</option>
            </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/shahib/Coding/Tanean laravel/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>