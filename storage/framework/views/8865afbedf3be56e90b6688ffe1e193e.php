...
<?php $__env->startSection('title', $article->title . ' - TANEAN.ID'); ?>
            ...
            <div class="flex items-start justify-between border-b shadow-sm p-2 rounded-md relative z-[1]">
                <div class="flex flex-col items-start">
                    <div>
                        ...
                        <span class="text-sm font-semibold"><?php echo e($article->author); ?></span>
                    </div>

                    <div class="flex items-center">
                        <span
                            class="text-sm text-gray-500"><?php echo e($article->published_at?->format('d M Y H:i') ?? $article->created_at->format('d M Y H:i')); ?>
                        ...
                        <span class="text-sm font-semibold capitalize"><?php echo e($article->category); ?></span>
                    </div>
                </div>
                        ...
                        <div class="py-2">
                            ...
                            <div class="flex justify-around py-3 border-b">
                                ...
                                <button id="share-twitter"
                                    ...
                                    <img src="<?php echo e(asset('build/assets/images/x.png')); ?>" alt="" class="">
                                </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/shahib/Coding/Tanean laravel/resources/views/articles/show.blade.php ENDPATH**/ ?>