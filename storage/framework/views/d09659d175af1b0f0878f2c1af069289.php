                ...
                <ul
                    ...
                    <li>
                        <a href="<?php echo e(route('article.category', 'warta')); ?>"
                            class="hover:text-tanean-beige <?php echo e(isset($category) && $category == 'warta' ? '!text-tanean-beige' : ''); ?>">
                            Warta
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('article.category', 'warita')); ?>"
                            class="hover:text-tanean-beige <?php echo e(isset($category) && $category == 'warita' ? '!text-tanean-beige' : ''); ?>">
                            Warita
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('article.category', 'swara')); ?>"
                            class="hover:text-tanean-beige <?php echo e(isset($category) && $category == 'swara' ? '!text-tanean-beige' : ''); ?>">
                            Swara
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('article.category', 'lensa')); ?>"
                            class="hover:text-tanean-beige <?php echo e(isset($category) && $category == 'lensa' ? '!text-tanean-beige' : ''); ?>">
                            Lensa
                        </a>
                    </li>
                </ul>
   ...
   transition-opacity duration-300">
    ...
    <footer class="font-display bg-tanean-beige text-[#f2f0eb]">
        <div class="container mx-auto px-6 pt-16 md:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    <div>
                        <a href="<?php echo e(route('home')); ?>" class="font-holtwood text-3xl text-tanean-dark tracking-wide">TANEAN.ID</a>
                    </div>
                    <!-- Social Media -->
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li><a href="<?php echo e(route('article.category', 'warta')); ?>"
                                class="hover:text-tanean-dark">Warta</a>
                        </li>
                        <li><a href="<?php echo e(route('article.category', 'swara')); ?>"
                                class="hover:text-tanean-dark">Swara</a>
                        </li>
                        <li><a href="<?php echo e(route('article.category', 'warita')); ?>"
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-black/50 opacity-0 pointer-events-none z-50 transition-opacity duration-300">
        <div class="relative bg-[#f2f0eb] w-72 h-full p-6 -translate-x-full transition-transform duration-300 ease-out">
            ...
            <form action="<?php echo e(route('home')); ?>" method="GET" class="mt-10 flex w-full items-center gap-3 rounded-full bg-gray-200 px-4 py-2.5">
                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <input type="search" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari..." aria-label="Cari artikel"
            ...
            <div class="mt-8 space-y-3">
                ...
                <a href="<?php echo e(route('login')); ?>" class="font-display block border text-center py-2 rounded">Masuk</a>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/shahib/Coding/Tanean laravel/resources/views/layouts/app.blade.php ENDPATH**/ ?>